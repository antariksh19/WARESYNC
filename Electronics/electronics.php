...
<body>
    <div id="preload-screen" class="preload-screen">
        <div class="preload-text">Electronics</div>
    </div>
    ...
    <div class="container">
        <nav class="sidebar">
            <ul>
                ...
                <li class="current-page"><a href="../Electronics/electronics.php">Electronics</a></li>
        ...
        <main class="content">
            ...
            <div class="card-container">
                <?php
                    $categories = ['Mobile Phones', 'Tablets', 'Laptops', 'Gamestations', 'VRs', 'TVs', 'Speakers', 'Earphones'];
                    foreach ($categories as $category) {
                        $query = "SELECT * FROM electronics WHERE type = '$category';";
