...
<body>
    <div id="preload-screen" class="preload-screen">
        <div class="preload-text">Miscellaneous</div>
    </div>
    ...
    <div class="container">
        <nav class="sidebar">
            <ul>
                ...
                <li class="current-page"><a href="../Miscellaneous/miscellaneous.php">Miscellaneous</a></li>
            </ul>
        </nav>
        <main class="content">
            <h1>Collection</h1>
            <div class="card-container">
                <?php
                    $categories = ['Bottles', 'Pen and Pencils', 'Bags', 'Suitcases', 'Containers'];
                    foreach ($categories as $category) {
                        $query = "SELECT * FROM miscellaneous WHERE type = '$category';";
